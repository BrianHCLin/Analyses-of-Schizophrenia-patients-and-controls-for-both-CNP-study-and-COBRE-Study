...
Classify(COBRE_train, COBRE_train$prediction,"Subject_Type", 0.45)

Classify(COBRE_test, COBRE_test$prediction,"Subject_Type", 0.45)
...
Accuracy.k <- cv.error(COBRE_logi_subset, "Subject_Type", cut_off = 0.45)
Accuracy.k
mean(Accuracy.k)
```
