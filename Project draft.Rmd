...
AccuracyCutoffInfo <- function( train, test, predict, actual )
{
	...
	{
	  levels(test[[actual]]) <- c(0,1)
	  levels(train[[actual]]) <- c(0,1)
...
Classify(CNP_train, CNP_train$prediction,"Subject_Type", 0.8 )

Classify(CNP_test, CNP_test$prediction,"Subject_Type", 0.8 )
...
Accuracy.k <- cv.error(CNP_logi_subset, "Subject_Type",cut_off = 0.8)
Accuracy.k
mean(Accuracy.k)
...
Classify(COBRE_train, COBRE_train$prediction,"Subject_Type", 0.35)

Classify(COBRE_test, COBRE_test$prediction,"Subject_Type", 0.35)
...
Accuracy.k <- cv.error(COBRE_logi_subset, "Subject_Type", cut_off = 0.35)
Accuracy.k
mean(Accuracy.k)
```
