...
#Find interaction
gg_int <- gg_interaction(find.interaction(rfsrc_m1, xvar.names = names(CNP_logi_subset[,-c(1)]), sorted = FALSE))
...
#Find interaction
gg_int <- gg_interaction(find.interaction(rfsrc_m2, xvar.names = names(COBRE_logi_subset[,-c(1)]), sorted = FALSE))
plot(gg_int)
...
#find interaction
gg_int <- gg_interaction(find.interaction(rfsrc_m3, xvar.names = names(Data_logi[,-c(1)]), sorted = FALSE))
plot(gg_int)
